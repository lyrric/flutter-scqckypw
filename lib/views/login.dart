...
class _FormSate extends State<_FormView>{
  ...
  TextEditingController _usernameController = new TextEditingController(text: '123123');
  TextEditingController _passwordController = new TextEditingController(text: '123123');
